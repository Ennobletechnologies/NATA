    ...
    <div class="container">
        <div class="col-md-4 col-sm-12">
            <ol class="breadcrumb">
                ...
                <li class="active">Advisory Council</li>
            </ol>
        </div>
    ...
    <div class="container inner-content ">
        <div class="row border-dot-bottom">
            <div class="col-md-9 ">
             ...
             <div class="margin-bottom-10 advisory">
          <div class="row">
            <div class="col-md-12 col-sm-12 col-xs-12">	<img src="<?php echo base_url();?>img/advisoryCouncil/premsagar.jpg" class="img-responsive">
              <p>Prem Sagar Reddy, MD<br>
                <i>Chairman</i></p>
            </div><div class="col-md-3 col-sm-3 col-xs-3"> 			<img src="<?php echo base_url();?>img/advisoryCouncil/avnreddy.jpg" class="img-rounded" width="304" height="220">
              <p>Sri A.V.N Reddy <br>
                <i>Member</i></p>
            </div>
            <div class="col-md-3 col-sm-3 col-xs-3"> 			<img src="<?php echo base_url();?>img/sc_2015/Help_Line_Adisesha_Reddy_Bellam_2.jpg" class="img-rounded" width="304" height="220">
              <p>Dr. Adisesha Reddy Bellam <br>
                <i>Member</i></p>
            </div>
            <div class="col-md-3 col-sm-3 col-xs-3"> <img src="<?php echo base_url();?>img/blank-face.jpg" class="img-rounded" width="304" height="220">
              <p>Jithender Reddy <br>
                <i>Member</i></p>
            </div>
            <div class="col-md-3 col-sm-3 col-xs-3"> <img src="<?php echo base_url();?>img/bod/StanleyReddy.jpg" class="img-rounded" width="304" height="220">
              <p>Dr. Stanley Reddy <br>
                <i>Member</i></p>
            </div>
        </div>
        </div>
