    ...
    <div class="container">
        <div class="col-md-4 col-sm-12">
            <ol class="breadcrumb">
                ...
                <li class="active">North Coordinators</li>
            </ol>
        </div>
        ...
        <div class="row">
            <div class="col-md-9 ">
                <div class="news-heading">
                    <h4>Regional Coordinators list – NORTH</h4>
                </div>
                <div class="margin-bottom-10">
                    <table class="table table-bordered">
                        ...
                        <tr>
                            <td>RC-MI</td>
                            <td>Govardhan Pinnamareddy </td>                       
                        </tr>
                        <tr>
                            <td>RC-MI</td>
                            <td>Jagan Reddy Konda </td>                            
                        </tr>
                        <tr>
                            <td>RC-MI</td>
                            <td>Janardhan Reddy Bhemanadhuni </td>
                        </tr>
                        <tr>
                            <td>RC-MI</td>
                            <td>Loka Reddy Vepamakula </td>
                        </tr>
                        <tr>
                            <td>RC-MI</td>
                            <td>Nanda Kumar Reddy Pothapu </td>
                        </tr>
                        <tr>
                            <td>RC-MI</td>
                            <td>Rayalacheruvu Ashwin </td>
                        </tr>
                        <tr>
                            <td>RC-MI</td>
                            <td>Sankar Reddy Ramasani </td>
                        </tr>
                        <tr>
                            <td>RC-MI</td>
                            <td>Santhosh Reddy Yellu </td>
                        </tr>
                        <tr>
                            <td>RC-MI</td>
                        ...
                        <tr>
                            <td>RC-MI</td>
                            <td>Venkateswara Reddy Bollavaram </td>
                        </tr>
                        <tr>
                            <td>RC-IL</td>
                            <td>Bala Kesavamatham </td>
                        </tr>
                        <tr>
                            <td>RC-IL</td>
                            <td>Hari Reddy Takkasila </td>
                        </tr>
                        <tr>
                            <td>RC-IL</td>
                            <td>Krishna Rao Poladi</td>
                        </tr>
                        <tr>
                            <td>RC-IL</td>
                            <td>Prasad Mutyala </td>
                        </tr>
                        <tr>
                            <td>RC-IL</td>
                            <td>Sudhakar Reddy Kona </td>
                        </tr>
                        <tr>
                            <td>RC-IL</td>
                            <td>Venkatarami Reddy Yerrabolu </td>
                        </tr>
                    </table>
                </div>
                <div class="margin-bottom-10">
