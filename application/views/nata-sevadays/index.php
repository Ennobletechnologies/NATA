<div class="slider-innder"> <img src="<?php echo base_url();?>img/index-sliders/newsletter-banner.jpg" class="img-responsive" alt="newsletter"/></div>
  ...
  <div class="container inner-content">
    <div class="row">
      <div class="col-md-9 col-sm-12 news-block">
        ...
        <?php foreach ($nata_seva as $nata_seva_data):?>
        <div class="row">
          <div class="col-md-4 col-sm-5"> <img src="<?php echo base_url();?>public/natasevadays/<?php echo $nata_seva_data['nseva_image'];?>" class="img-responsive"  alt="news-1"> </div>
          <div class="col-md-8 col-sm-7">
            <div class="latest-news ">
              ...
              <a href="<?php echo base_url();?>events/nata_seva_days_view/<?php echo $nata_seva_data['nseva_id'];?>" class="btn slide_btn">Read More</a> </div>
          </div>
        </div>
