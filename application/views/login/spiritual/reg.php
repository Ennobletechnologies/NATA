<script>
    ...
    text = new Array()
    type = Array('Life(VIP In Srinivasa Kalyanam)', 'Life', 'NATA');
    value = Array(116,75,50);
  ...
  <div class="container inner-content">
    <div class="row">
      <div class="col-md-9 col-sm-12 news-block">
		...
		<form action="http://www.nataus.org/spiritual/register">
	  <center >  <input type="submit" class="btn btn-danger" value="Homepage"/> </center>
	   </form>
        <div class="row">
			...
			<div class="form-group col-md-3 col-sm-6">
              <input class="form-control" type="number" id="adult_attend" name="adult_attend" placeholder="adult" value="<?php echo set_value('adult_attend');?>"/>
			  <span class="error"><?php echo form_error('adult_attend'); ?></span>
			</div>
			<div class="form-group col-md-3 col-sm-6">
