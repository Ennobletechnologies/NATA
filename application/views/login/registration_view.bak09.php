    ...
    <div class="row">
      <div class="col-md-9 news-block">
        <div class="row">
          ...
          <div class="col-md-12">
            <h4 class="grey">(50% off until May 31st 2015)</h4>
            <p class="padding-top-10">The fields marked with <span class="required">*</span> must be completed.</p>
          </div>
          ...
          <form id="frmSubscription" action="<?php echo base_url(); ?>user/registration" method="post" name="Nata_Enquiry" onsubmit="return validateForm()">
            ...
            <div class="form-group col-md-6 col-sm-6">
              <label for="user_name">Member Last Name:<span class="required">*</span></label>
              <input class="form-control" type="text" id="last_name" name="last_name" value="<?php echo set_value('last_name');?>" />
              <span class="error"><?php echo form_error('user_name'); ?></span> </div>
            <div class="form-group col-md-6 col-sm-6">
            ...
            <div class="form-group col-md-6 col-sm-6">
              ...
              <span class="error"><?php echo form_error('name_of_spouse'); ?></span> </div>
            <div class="form-group col-md-6 col-sm-6">
            ...
            <div class="form-group col-md-6 col-sm-6">
              ...
              <span class="error"><?php echo form_error('cellphone'); ?></span> </div>
            ...
            <div class=" form-group col-md-12">
              <table class="table">
                <tr>
                  <td colspan="3">Membership Category<span class="required">*</span></td>
                </tr>
                ...
                <tr>
                  <td width="50%"><input type="radio" name="member_cat" value="Diamond" onclick="populate(this.value,this.form)">
                    Diamond</td>
                  <td width="25%">Category(Check One)</td>
                  <td width="25%">$ 25,00</td>
                </tr>
                <tr>
                  <td></td>
                  <td style="text-decoration: line-through;">0</td>
                  <td>$ 12,500</td>
                </tr>
                <tr>
                  <td><input type="radio" name="member_cat" value="Platinum" onclick="populate(this.value,this.form)">
                    Platinum</td>
                  <td style="text-decoration: line-through;">$ 10,000</td>
                  <td>$ 5,000</td>
                </tr>
                <tr>
                  <td style="color: #f00;
                    ...
                    Gold</td>
                  <td style="text-decoration: line-through;">$ 5,000</td>
                  <td>$ 2,500</td>
                </tr>
                <tr>
                  <td><input type="radio" name="member_cat" value="Silver" onclick="populate(this.value,this.form)">
                    Silver</td>
                  <td style="text-decoration: line-through;">$ 2,500</td>
                  <td>$ 1,250</td>
                </tr>
                <tr>
                ...
                <tr>
                  ...
                  <td> $
                    <input type="text" id="membership_amount" name="membership_amount" readonly="readonly" value="50" ></td>
                  <td></td>
                </tr>
                <tr>
                  ...
                  <td> $
                    <input type="text" id="donation_towards_nata" name="donation_towards_nata" value="0" onchange="updatetotal(this.value,this.form)" /></td>
                  <td></td>
                </tr>
                <tr>
                  <td><label for="total_amount_enclosed">Total amount enclosed:</label></td>
                  <td> $
                    <input type="text" id="total_amount_enclosed" name="total_amount_enclosed" readonly="readonly"  value="50"></td>
                  <td></td>
                </tr>
                <tr>
                ...
                <tr>
                  <td colspan="3" ><img class="alignleft size-full wp-image-1157 img-responsive" title="cards" src="<?php echo base_url();?>img/cards.jpg" alt="security"></td>
                </tr>
              </table>
            </div>
          </form>
      ...
      <div class="col-md-3 latest-videos">
        <div class="row">
        <div class="col-md-12">
        <img src="../img/member-reg.jpg" class="img-responsive">
        </div>
        <div class="news-heading">
          <h4>Latest Videos</h4>
        </div>
        <div class="clearfix border-dot-bottom"></div>
          <div class="col-md-12">
            ...
            <img src="../img/gallery/gallery14.jpg"  class="img-responsive"> </div>
        </div>
        <div class="clearfix border-dot-bottom"></div>
        <div class="row">
          <div class="col-md-12">
            ...
            <p><span class="fa fa-clock-o">&nbsp;</span>June 10, 2014</p>
            <img src="../img/prem_mallanna.jpg"  class="img-responsive"> </div>
        </div>
        <div class="clearfix border-dot-bottom"></div>
        <div class="row">
