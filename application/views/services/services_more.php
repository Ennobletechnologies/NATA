...
<div class="inner-page">
    <div class="container inner-content">
        <div class="row">
            <div class="col-md-9 news-block"><div class="news-heading">
                ...
                <div class="row">
                    ...
                    <?php foreach ($services_info as $news_info); ?>
                    <div class="col-md-12">
                        <div class="videoThum"> <a href="<?php echo base_url(); ?>services/view/<?php echo $news_info['services_id']; ?>"><img src="<?php echo base_url(); ?>public/services/<?php echo $news_info['services_img']; ?>" class="img-responsive thumbnail-img"  alt="news-1"> </a>
                            <div class="videoInfo padding-top-20">
                                <h5><?php echo strip_slashes($news_info['services_title']); ?></h5>
                                <p><?php echo strip_slashes($news_info['services_desc']); ?> </p>
                                <b>Published on:
                                    <?php
        ...
        <hr/>
        <div class="row tv-coverage"><div class="col-md-12">
            <div class="news-heading">
                <h4>TV Coverage</h4>
            </div></div>
            <div class="col-md-4">
