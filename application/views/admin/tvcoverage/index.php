      ...
      <div class=" col-lg-12 col-md-12">
        <div class="panel panel-primary">
          <div class="panel-heading">
            ...
            <div class="pull-right"> <a href="<?php echo base_url();?>admin/addtvcoverage" class="btn btn-success">+ Add TV Coverage</a> </div>
          </div>
          <div class="panel-body">
            <table class="table table-bordered">
              ...
              <tbody>
                <?php $i=1; foreach($tvcoverage as $key=>$view_topstory){ ?>
                <tr>
                  <td><?php echo $i; ?></td>
                  <td><?php echo $view_topstory['title']; ?></td>
                  <td><?php if($view_topstory['image']){?>
                    <img src="<?php echo base_url(); ?>public/tvcoverage/<?php echo $view_topstory['image']; ?>" class="img-responsive" width="100px" />
                    <?php } else {
                  echo "No image";}?></td>
                  <td><a href="<?php echo base_url();?>admin/edittvcoverage/<?php echo $view_topstory['id']; ?>" class="btn-edit"><i class="fa fa-pencil"></i>Edit</a></td>
                  <td><a href="<?php echo base_url(); ?>admin/deletetvcoverage/<?php echo $view_topstory['id']; ?>" class="btn-delete"><i class="fa fa-trash"></i>Delete</a></td>
                </tr>
                <?php $i++; } ?>
              </tbody>
            </table>
