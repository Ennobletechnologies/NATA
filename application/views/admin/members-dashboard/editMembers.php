...
<body>
  <div class="header">
    ...
    <div class="header_right">Welcome Admin, <a href="<?php echo base_url(); ?>user/logout" class="logout">Logout</a><br>
    ...
    <div id="right_wrap">
      <div id="right_content">
        <ul id="tabsmenu" class="tabsmenu">
          <li class="active"><a href="#tab1">Edit Members</a></li>
        </ul>
        <div id="tab1" class="tabcontent">
          <div class="form">
            <?php foreach ($editUsers as $key=>$users); ?>
            <?php echo form_open_multipart('admin/updateMembers'); ?>
            <table style="width:720px;">
              <tr>
                <td>User Name</td>
                <td><?php echo form_input(array("name"=>'username',"value"=>$users['username'])); ?>
                <td><?php echo form_error('username'); ?></td>
              </tr>
              <tr>
                <td>Password</td>
                <td><?php echo form_input(array("name"=>'password',"value"=>$users['password'])); ?>
                <td><?php echo form_error('password'); ?></td>
              </tr>
              <tr>
                <td>Email</td>
                <td><?php echo form_input(array("name"=>'email',"value"=>$users['email'])); ?>
