        ...
        <div class="panel panel-primary">
            ...
            <table class="table table-bordered">
                                <tr>
                                    <td>Telugu Title</td>
                                    <td>
                                        <?php echo form_input('telugu_title', set_value('telugu_title')); ?>
                              ...
                              <tr>
                                    <td>Telugu Url</td>
                                    <td>
                                        <?php echo form_input('telugu_url', set_value('telugu_url')); ?>
