        ...
        <div class="panel panel-primary">
          ...
          <div class="panel-body">
            <table class="table table-bordered">
              <tr>
                <td>Title</td>
                <td><?php echo form_input(array("name"=>'news_title',"value"=>$rec_topstory['news_title'])); ?><span class="relquired"><?php echo form_error('news_title'); ?></span></td>
              </tr>
              <tr>
                <td>Description:</td>
                <td><?php echo form_textarea(array("name"=>'news_description',"id"=>'area2',"value"=>stripslashes(str_replace(array('\n','\r'),' ',$rec_topstory['news_desc'])))); ?>
                <span class="relquired"><?php echo form_error('news_description'); ?></span></td>
              </tr>
              <tr>
                <td>News Pic:</td>
              ...
              <tr>
                <td></td>
                <td><input type="hidden" name="newsid" value="<?php echo $rec_topstory['news_id']; ?>" />
