        ...
        <div id="right_wrap">
            <div id="right_content" style="margin:0 auto; width:98%; margin-top:50px;">
                ...
                <span class="form_sub_buttons">
                    <a href="<?php echo base_url();?>admin/add_sports_results" class="button green">+ Add New</a>
                ...
                <table id="rounded-corner">
                    <thead>
                        ...
                        <tr>
                            ...
                            <td><?php echo $results_data['played'];?></td>
                            <td><?php echo $results_data['win'];?></td>
                            <td><?php echo $results_data['lost'];?></td>
                            <td><?php echo $results_data['draw'];?></td>
                            <td><?php echo $results_data['points'];?></td>
                            <td><?php 
                            $pdate = date('m/d/Y',  strtotime($results_data['pdate']));
                            echo $pdate;?></td>
                            <td><a href="<?php echo base_url();?>admin/edit_sports_results/<?php echo $results_data['result_id'];?>" class="btn green"><i class="fa fa-pencil"></i>Edit</a></td>
                             <td><a class="btn red" href="<?php echo base_url('admin/delete_sports_results'); ?>/<?php echo $results_data['result_id'];?>" onClick="return confirm('Are you sure you want to delete <?php echo $results_data['team_name'];?> Team ?\n Click Ok to confirm!');"><i class="fa fa-trash-o"></i> Delete</a></td>
                        </tr>
                        <?php
                        $sno++;
                        endforeach;?>
