        ...
        <div id="right_wrap">
            <div id="right_content" style="margin:0 auto; width:98%; margin-top:50px;">
                ...
                <span class="form_sub_buttons">
                    <a href="<?php echo base_url();?>admin/add_grounds" class="button green">+ Add New</a>
                ...
                <table id="rounded-corner">
                    <thead>
                        ...
                        <tr>
                            <td><?php echo $sno;?></td>
                            <td><?php echo $grounds_data['title'];?></td>
                            <td><?php 
                            $pdate = date('m/d/Y',  strtotime($grounds_data['pdate']));
                            echo $pdate;?></td>
                            <td><a href="<?php echo base_url();?>admin/edit_grounds/<?php echo $grounds_data['ground_id'];?>" class="btn green"><i class="fa fa-pencil"></i>Edit</a></td>
                             <td><a class="btn red" href="<?php echo base_url('admin/delete_grounds'); ?>/<?php echo $grounds_data['ground_id'];?>" onClick="return confirm('Are you sure you want to delete grounds page ?\n Click Ok to confirm!');"><i class="fa fa-trash-o"></i> Delete</a></td>
                        </tr>
                        <?php
                        $sno++;
                        endforeach;?>
