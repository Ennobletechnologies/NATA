    ...
    <div class="center_content">  
        <div id="right_wrap">
            <div id="right_content" style="margin:0 auto; width:98%; margin-top:50px;">
                ...
                <form method="post" action="<?php echo base_url();?>admin/update_about_league">
                <table >
                    <thead>
                        <tr>
                            <td>&nbsp;</td>
                        ...
                        <tr>
                            <td>League Title</td>
                            <td><input type="text" name="league_title" value="<?php echo $league_data['league_title'];?>"></td>
                        </tr>
                        <tr>
                            <td>League Content</td>
                            <td><textarea name="content" id="league_content" required="" class="form-control"><?php echo $league_data['content'];?></textarea></td>
                        </tr>
                        <tr>
                            <td><input type="submit" name="submit" value="<?php if(isset($league_data['league_id'])!=''){
echo 'Update';}else{
        echo 'Add';}?>" class="backtoadmin">
                            <td><input type="hidden" name="pst_id" value="<?php if(isset($league_data['league_id'])){
echo $league_data['league_id'];}?>">    
