    ...
    <div class="center_content">  
        <div id="right_wrap">
            <div id="right_content" style="margin:0 auto; width:98%; margin-top:50px;">
                ...
                <form method="post" action="<?php echo base_url();?>admin/update_committee">
                <table >
                    <thead>
                        <tr>
                            <td>&nbsp;</td>
                        ...
                        <tr>
                            ...
                            <td><input type="text" name="committee_name" value="<?php echo $committees_data['committee_name'];?>"></td>
                        </tr>
                        <tr>
                            <td><input type="submit" name="submit" value="<?php if(isset($committees_data['committee_id'])!=''){
echo 'Update';}else{
        echo 'Add';}?>" class="backtoadmin">
                            <td><input type="hidden" name="pst_id" value="<?php if(isset($committees_data['committee_id'])){
echo $committees_data['committee_id'];}?>">    
