        ...
        <div id="right_wrap">
            <div id="right_content" style="margin:0 auto; width:98%; margin-top:50px;">
                ...
                <span class="form_sub_buttons">
                    <a href="<?php echo base_url();?>admin/add_committee" class="button green">+ Add New</a>
                ...
                <table id="rounded-corner">
                    <thead>
                        ...
                        <?php 
                        $sno = 1;
                        foreach ($committees as $committees_data):?>
                        <tr>
                            <td><?php echo $sno;?></td>
                            <td><?php echo $committees_data['committee_name'];?></td>
                            <td><?php 
                            $pdate = date('m/d/Y',  strtotime($committees_data['pdate']));
                            echo $pdate;?></td>
                            <td><a href="<?php echo base_url();?>admin/edit_committee/<?php echo $committees_data['committee_id'];?>" class="btn green"><i class="fa fa-pencil"></i>Edit</a></td>
                             <td><a class="btn red" href="<?php echo base_url('admin/delete_committee'); ?>/<?php echo $committees_data['committee_id'];?>" onClick="return confirm('Are you sure you want to delete <?php echo $committees_data['committee_name'];?> Committee ?\n Click Ok to confirm!');"><i class="fa fa-trash-o"></i> Delete</a></td>
                        </tr>
                        <?php
                        $sno++;
                        endforeach;?>
