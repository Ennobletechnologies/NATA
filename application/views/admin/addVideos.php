...
<section class="member-home">
  <div class="container">
    <div class="row">
      <div class=" col-lg-12 col-md-12"> <?php echo form_open_multipart('admin/insertVideos'); ?>
        <div class="panel panel-primary">
          <div class="panel-heading ">
            <ol class="breadcrumb">
              <li><a class="backtoadmin" href="<?php echo base_url() ?>admin">Back to Admin</a></li>
              <li><a class="backtoadmin" href="<?php echo base_url() ?>admin/videos">Videos</a></li>
          ...
          <div class="panel-body">
            <table class="table table-bordered">
              <tr>
                <td>Title</td>
                <td><?php echo form_input('title',set_value('title')); ?> <span class="required"><?php echo form_error('title'); ?></span></td>
              </tr>
              <tr>
                <td>Description:</td>
                <td><?php echo form_textarea('description',set_value('description')); ?> <span class="required"><?php echo form_error('description'); ?></span></td>
              </tr>
              <tr>
                <td>Picture</td>
                <td><input type="text" name="videopic" id="videopic"></td>
              </tr>
              <tr>
                <td></td>
