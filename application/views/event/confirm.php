        ...
        <div class="col-md-10 col-xs-offset-1">
          <hr class="colorgraph">
            ...
            <div class="col-xs-6 col-sm-6 col-md-6">
              ...
              <div class="form-group">
                <label>Title</label>
                <input type="text" name="title" id="title" class="form-control input-md" value="<?php echo $_POST['title']; ?>" tabindex="2" readonly>
              </div>
            </div>
              <?php } ?>
            ...
            <div class="col-xs-6 col-sm-6 col-md-6">
              <div class="form-group">
                ...
                <input type="phoneNumber" name="phoneNumber" class="form-control input-md" value="<?php echo $_POST['phoneNumber']; ?>" tabindex="6" readonly>
                       ...
                       <?php if($seg_value==24|| $seg_value==25){?> 
              <div class="col-xs-6 col-sm-6 col-md-6">
                <div class="form-group">
				<label>Age</label>
		...
		<label> link</label>
			...
			<select name="city" class="form-control valid" id="" style="padding:5px;" readonly>
                ...
                <div class="form-group">
                  ...
                  <input type="text" name="add1" id="add1" value="<?php echo $_POST['add1']; ?>" class="form-control valid"  placeholder="Address1" tabindex="4" readonly/>
                </div>
              </div>
                ...
                <div class="form-group">
                  ...
                  <input type="text" name="add2" id="add1" value="<?php echo $_POST['add2']; ?>" class="form-control valid"  placeholder="Address2" tabindex="5" readonly/>
                </div>
              </div>
         ...
         <div class="form-group">
              <label>State</label>
              <input type="text" name="state" id="state" value="<?php echo $_POST['state']; ?>" class="form-control input-md" placeholder="state" tabindex="9" readonly/>
                ...
                <div class="form-group">
                  ...
                  <input type="text" name="zip" id="zip" value="<?php echo $_POST['zip']; ?>" class="form-control input-md" placeholder="Zip Code" tabindex="9" readonly/>
                </div>
              </div>
                ...
                <div class="form-group">
                     <label>Country</label>
                  <input type="text" name="country" id="country" class="form-control input-md" value="<?php echo $_POST['country']; ?>" placeholder="Country" tabindex="16" readonly />
                </div>
              </div>   
                ...
                <div class="form-group">
                  ...
                  <input type="text" name="homephone" value="<?php echo $_POST['homephone']; ?>" id="homephone" class="form-control input-md" placeholder="Home phone" tabindex="9" readonly/>
                </div>
              </div> 
                <div class="col-xs-6 col-sm-6 col-md-6">
                <div class="form-group">
                    <label>Film Title</label>
                    <input type="text" name="filmtitle" id="filmtitle" class="form-control input-md"  value="<?php echo $_POST['filmtitle']; ?>" tabindex="3" readonly/>
                </div>
              </div>
                    <div class="col-xs-6 col-sm-6 col-md-6">
                <div class="form-group">
                    <label>Film Name</label>
                  <input type="text" name="filmname" id="filmname"  value="<?php echo $_POST['filmname']; ?>" class="form-control input-md" placeholder="Short-Film Name" tabindex="16" readonly/>
                </div>
              </div> 
                ...
                <div class="form-group">
                  ...
                  <input type="text" name="filmduration" id="filmduration" value="<?php echo $_POST['filmduration']; ?>" class="form-control input-md" placeholder="Short-Film Duration" tabindex="17" readonly/>
                </div>
              </div>
                    <div class="col-xs-6 col-sm-6 col-md-6">
                <div class="form-group">
                    <label>Film Genre</label>
                  <input type="text" name="filmgenre" id="filmgenre" value="<?php echo $_POST['filmgenre']; ?>" class="form-control input-md" placeholder="Short-Film Genre" tabindex="18" readonly/>
                </div>
                </div>
                ...
                <div class="form-group">
                  ...
                  <input type="text" name="addlink1" id="addlink1" value="<?php echo $_POST['addlink1']; ?>" class="form-control input-md"  tabindex="17" readonly/>
                </div>
              </div>
                    <div class="col-xs-6 col-sm-6 col-md-6">
                <div class="form-group">
                    <label>Additional Link 2 </label>
                  <input type="text" name="addlink2" id="addlink2" value="<?php echo $_POST['addlink2']; ?>" class="form-control input-md"  tabindex="18" readonly/>
                </div>
                </div>
