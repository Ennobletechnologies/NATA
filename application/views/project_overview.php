    ...
    <div class="row">
      <div class="col-md-9 col-sm-12 news-block">
        <div class="row">
          ...
          <div class="col-md-12">
            <div class="latest-news projects-view ">
              ...
              <img src="<?php echo base_url();?>public/projects/<?php echo $projects_data['project_image'];?>" alt="project"/>
              <p><?php echo $projects_data['project_desc'];?></p>
            </div>
          </div>
    	  <div class="col-md-12">
		  <a href="<?php echo base_url();?>services/donations" class="btn btn-success">New Project Sponsorship</a>
		  </div>
        </div>
