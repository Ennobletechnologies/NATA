...
class Index extends CI_Controller {
    ...
    function addUser() {
        ...
        $sesdata = array(
            ...
            'filmtitle' => $this->input->post('filmtitle'),
            'filmname' => $this->input->post('filmname'),
            'filmduration' => $this->input->post('filmduration'),
            'filmgenre' => $this->input->post('filmgenre'),
            'addlink1' => $this->input->post('addlink1'),
            'addlink2' => $this->input->post('addlink2'),
    ...
    function success() {
        ...
        $this->email->attach($path . 'NATAShortFilmContest.docx');
        }
        $sent = $this->email->send();
        if ($sent) {
           if ($seg == 23)
           {
            $to1 = "shortfilm@nata2016.org";
            $this->email->to($to1);
