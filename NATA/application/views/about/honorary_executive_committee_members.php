    ...
    <div class="container">
        <div class="col-md-5 col-sm-12">
            <ol class="breadcrumb">
                ...
                <li class="active">Honorary Executive Committee Members</li>
            </ol>
        </div>
        <div class="col-md-7 col-sm-12 inner-marquee">
        ...
        <div class="row border-dot-bottom">
            <div class="col-md-9 ">
                <div class="news-heading">
                    <h4>Honorary Executive Committee Members</h4>
                </div>
                <div class="margin-bottom-10">
                    <img src="<?php echo base_url(); ?>img/HonoraryExecutiveCommitteeMembers.jpg" class="img-responsive thumbnail-img" alt="boardofdirectors">
                </div>
                <div class="margin-bottom-10">
