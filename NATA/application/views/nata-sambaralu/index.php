<div class="slider-innder"> <img src="<?php echo base_url();?>img/index-sliders/newsletter-banner.jpg" class="img-responsive" alt="events"/></div>
    ...
    <div class="row">
      <div class="col-md-9 col-sm-8 news-block">
        <div class="news-heading">
          <h4>Nata Sambaralu »</h4>
        </div>
        <?php foreach ($nsambaralu as $nsambaralu_data):?>
        <div class="row">
          <div class="col-md-4 col-sm-5 "> <img src="<?php echo $nsambaralu_data['ns_image'];?>" class="img-responsive"  alt="news-1"> </div>
          <div class="col-md-8 col-sm-7">
            <div class="latest-news ">
              <h5><?php echo $nsambaralu_data['ns_title'];?></h5>
              <p><span class="fa fa-clock-o">&nbsp;</span>
                <?php 
                           $result = $nsambaralu_data['published_on']; 
                            echo $result;?>
              </p>
              <p>
                <?php //echo strip_slashes($nsambaralu_data['ns_desc']);?>
              </p>
              <a href="<?php echo base_url();?>events/nata_sambaralu_view/<?php echo $nsambaralu_data['ns_id'];?>" class="btn slide_btn">Read More</a> </div>
          </div>
        </div>
