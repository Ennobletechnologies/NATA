            ...
            <div id="slider1_container" style="position: relative; margin: 0 auto;
                ...
                <div u="slides" style="cursor: move; position: absolute; left: 0px; top: 0px; width: 980px;
                    ...
                    <div id="test1">
						...
						<?php { ?>
						<img src="uploads/<?php echo $value['filename'];?>" style="position: absolute; top: 23px; left: 480px; width: 500px; height: 300px;">
						<img u="thumb" src="uploads/<?php echo $value['filename'];?>">
						<?php }?>
					      </div>
