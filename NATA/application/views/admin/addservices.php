...
<section class="member-home">
  <div class="container">
    <div class="row">
      <div class=" col-lg-12 col-md-12"> <?php echo form_open_multipart('admin/insert_services'); ?>
        <div class="panel panel-primary">
          ...
          <table class="table table-bordered">
            <tr>
              <td>Title</td>
              <td><?php echo form_input('services_title',set_value('services_title')); ?><span class="required"><?php echo form_error('services_title'); ?></span></td>
            </tr>
            <tr>
              <td>Description:</td>
              <td><?php echo form_textarea('services_description',set_value('services_description')); ?><span class="required"><?php echo form_error('services_description'); ?></span></td>
            </tr>
            <tr>
              <td>Picture</td>
