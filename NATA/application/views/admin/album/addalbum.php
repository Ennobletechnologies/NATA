...
<section class="member-home">
  <div class="container">
    <div class="row">
      <div class=" col-lg-12 col-md-12"> <?php echo form_open_multipart('admin/insertalbum'); ?>
        <div class="panel panel-primary">
          <div class="panel-heading ">
            ...
            <div class="pull-right"><input type="hidden" name="region" value="default" id="region">       
                  <input type="submit" class="btn btn-success" name="submit" value="Add Album" /></div>
          </div>
           ...
           <div class="form">
            <table class="table table-bordered">
              <tr>
                <td>Name</td>
                <td >
                <input type="text" name="name" placeholder="Album Name" class=" form-control" required="required"/>
				<!--<?php echo form_input('name',set_value('name')); ?></td>
                <td><?php echo form_error('name'); ?></td>-->
              </tr>
              <tr>
                <td>Album Image:</td>
                <td><input type="file" name="albumpic" required class="btn btn-default"></td>
              </tr>
              <tr>
                <td></td>
