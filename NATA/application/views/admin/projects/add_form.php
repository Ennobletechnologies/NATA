...
<section class="member-home">
          <div class="container">
    <div class="row">
              <div class="col-md-12"> <?php echo form_open_multipart('admin/insertproject'); ?>
        <div class="panel panel-primary">
            ...
            <table class="table table-bordered">
                      <tr>
                <td>Project Title</td>
                <td><?php echo form_input('project_title', set_value('project_title')); ?> <span class="required"><?php echo form_error('project_title'); ?></span></td>
              </tr>
                      <tr>
                <td>Project Description:</td>
                <td><?php echo form_textarea('project_desc', set_value('project_desc')); ?> <span class="required"><?php echo form_error('project_desc'); ?></span></td>
              </tr>
                      <tr>
                <td>Picture</td>
