...
<section class="member-home">
    ...
    <div class="row">
              <div class="col-md-12"> 
                            <?php echo form_open_multipart('admin/updatenata_mata'); ?>  
        <div class="panel panel-primary">
            ...
            <div class="pull-right">
                      <input type="submit" class="btn btn-success" name="submit" value="<?php if(isset($nata_mata_data['nm_id']) !='') echo 'Update'; ?>" />
                    </div>
          </div>
            ...
            <table class="table table-bordered">
                                <tr>
                                    <td>Project Title</td>
                                    <td>
                                        <input type="text" name="nm_title" value="<?php if(isset($nata_mata_data['nm_title']) !='') echo $nata_mata_data['nm_title']; ?>"/>
                                ...
                                <tr>
                                    <td><input type="hidden" name="published_on" value="<?php if(isset($nata_mata_data['published_on']) !='') echo $nata_mata_data['published_on']; ?>" /></td>
                                    <td>
                                        <input type="hidden" name="pst_id" value="<?php if(isset($nata_mata_data['nm_id']) !='') echo $nata_mata_data['nm_id']; ?>"/>
                                        <input type="submit" class="btn btn-success" name="submit" value="<?php if(isset($nata_mata_data['nm_id']) !='') echo 'Update'; ?>" /></td>
                                    </tr></table>
