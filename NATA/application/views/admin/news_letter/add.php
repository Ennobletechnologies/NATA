...
<section class="member-home">
  <div class="container">
    <div class="row">
      <div class=" col-lg-12 col-md-12"><?php echo form_open_multipart('admin/insertnl'); ?>
            ...
            <div class="form">
              <table class="table table-bordered">
                <tr>
                  <td>Title</td>
                  <td>
				  <?php echo form_input('news_title',set_value('news_title')); ?><span class="required"> <?php echo form_error('news_title','News Title Required'); ?></span></td>
                </tr>
                <tr>
                  <td>Description:</td>
                ...
                <tr>
                  <td><input type="hidden" name="multi[]" value="2" class=""></td>
