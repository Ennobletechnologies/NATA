...
<div id=">
    ...
    <div id="right_content">             
        ...
        <li class="active"><a href="#tab1">Add Events</a></li>
    ...
    <div id="tab1" class="tabcontent">
        ...
        <?php echo form_open_multipart('admin/insertevents'); ?>
            ...
            <?php echo form_input('events_title',set_value('events_title')); ?></td>
            <td>
            ...
            <tr>
            <td>Description:</td>
            <td><?php echo form_textarea('events_description',set_value('events_description')); ?></td>
            <td><?php echo form_error('events_description'); ?></td>
             </tr>
             <tr>
              <td>Pic:</td><td><?php echo form_upload('eventspic'); ?></td><td></td>
              </tr>
              <tr>
              <td></td>
              <td>
