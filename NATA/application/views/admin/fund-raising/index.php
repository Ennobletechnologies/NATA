      ...
      <div class=" col-lg-12 col-md-12">
        <div class="panel panel-primary">
          <div class="panel-heading ">
            ...
            <div class="pull-right"><a href="<?php echo base_url(); ?>admin/add_fund_raising" class="btn btn-success">+ Add Data</a></div>
          </div>
          ...
          <tr>
            <th >S.No</th>
            <th >Fund Raising Title</th>
            <th >Fund Raising Image</th>
            <th >Published on</th>
            <th >Edit</th>
            <th >Delete</th>
          </tr>
          ...
          <tr>
            <td><?php echo $sno;?></td>
            <td><?php echo $fund_data['fr_title'];?></td>
            <td><img src="<?php echo base_url();?>public/fundraising/<?php echo $fund_data['fr_image'];?>" width="100" height="100"/></td>
            <td><?php echo $fund_data['published_on'];?></td>
            <td><a href="<?php echo base_url('admin/edit_fund_raising');?>/<?php echo $fund_data['fr_id'];?>" class="btn-edit"><i class="fa fa-pencil"></i>Edit</a></td>
            <td><a class="btn-delete" href="<?php echo base_url('admin/delete_fund_raising'); ?>/<?php echo $fund_data['fr_id']; ?>" onClick="return confirm('Are you sure you want to delete <?php echo $fund_data['fr_title']; ?> fund raising ?\n Click Ok to confirm!');"><i class="fa fa-trash-o"></i> Delete</a></td>
          </tr>
          <?php
                                    $sno++;
                                endforeach;
          ...
          <tr>
            <td><h1 class="btn red" style="text-align: center">No fund raising found! add some funds.</h1></td>
          </tr>
          <?php     }
                            ?>
          <tr>
