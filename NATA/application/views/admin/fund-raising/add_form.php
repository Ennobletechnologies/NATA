...
.wide-content {
    ...
    <div class="row">
              <div class="col-md-12"> 
			   <?php echo form_open_multipart('admin/insertfund_raising'); ?>
        <div class="panel panel-primary">
            ...
            <ol class="breadcrumb">
                      ...
                      <li class="active">Add Fund Raising</li>
                    </ol>
            ...
            <table class="table table-bordered">
                      <tr>
                        ...
                        <td><?php echo form_input('fr_title', set_value('fr_title')); ?><span class="required"> <?php echo form_error('fr_title'); ?></span></td>
                      </tr>
                      <tr>
                        <td>Fund raising Description:</td>
                        <td><?php echo form_textarea('fr_desc', set_value('fr_desc')); ?><span class="required"> <?php echo form_error('fr_desc'); ?></span></td>
                      </tr>
                      <tr>
                        <td>Picture</td>
