  ...
  <div class="container">
    <div class="row">
      <div class=" col-lg-12 col-md-12">
        <?php foreach ($caddress as $key=>$rec_topstory); ?>
        ...
        <div class="panel panel-primary">
          <div class="panel-heading ">
            <ol class="breadcrumb">
              ...
              <li class="active">Edit Change of Address</li>
             
            </ol> <div class="pull-right"><input type="submit" class="btn btn-success" name="submit" value="Submit" /></div>
          </div>
          <div class="panel-body">
            <table class="table table-bordered">
              <tr>
                <td>Title</td>
                <td><?php echo form_input(array("name"=>'title',"value"=>$rec_topstory['ca_title'])); ?> <span class="required"> <?php echo form_error('title'); ?></span></td>
              </tr>
              <tr>
                <td>Description:</td>
                <td><?php echo form_textarea(array("name"=>'body',"id"=>'area2',"class"=>'wide-content',"value"=>stripslashes(str_replace(array('\n','\r'),' ',$rec_topstory['ca_body'])))); ?> <span class="required"><?php echo form_error('body'); ?></span></td>
              </tr>
              <tr>
                <td></td>
                <td><input type="hidden" name="id" value="<?php echo $rec_topstory['ca_id']; ?>" />
