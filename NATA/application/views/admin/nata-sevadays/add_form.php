...
<section class="member-home">
          <div class="container">
    <div class="row">
              <div class="col-md-12"> <?php echo form_open_multipart('admin/insertnata_seva_days'); ?>
        <div class="panel panel-primary">
            ...
            <ol class="breadcrumb">
                      ...
                      <li class="active">Add Nata seva day</li>
                    </ol>
            ...
            <table class="table table-bordered">
                ...
                <td><?php echo form_input('nseva_title', set_value('nseva_title')); ?> <span class="required"><?php echo form_error('nseva_title'); ?></span></td>
              </tr>
                      <tr>
                <td>Nata seva day Description:</td>
                <td><?php echo form_textarea('nseva_desc', set_value('nseva_desc')); ?> <span class="required"><?php echo form_error('nseva_desc'); ?></span></td>
              </tr>
                      <tr>
                <td>Picture</td>
                <td><?php echo form_upload('nseva_image'); ?></td>
              </tr>
                      <tr>
