  ...
  <div class="container">
    <div class="row">
      <div class=" col-lg-12 col-md-12">
        ...
        <?php echo form_open_multipart('admin/updatepolicies'); ?>
        <div class="panel panel-primary">
          <div class="panel-heading ">
            <ol class="breadcrumb">
              <li><a class="backtoadmin" href="<?php echo base_url() ?>admin">Back to Admin</a></li>
              <li><a class="backtoadmin" href="<?php echo base_url() ?>admin/Policies">Policies</a></li>
              <li class="active">Edit Policies</li>
            </ol>
            <div class="pull-right"> <a href="<?php echo base_url();?>admin/addpolicies" class="btn btn-success">+ Add New</a>
          ...
          <div class="panel-body">
            <table class="table table-bordered">
              <tr>
                <td>Title</td>
                <td><?php echo form_input(array("name"=>'title',"value"=>$rec_topstory['title'])); ?> <span class="required"><?php echo form_error('title'); ?></span></td>
              </tr>
              <tr>
                <td>Description:</td>
                <td><?php echo form_textarea(array("name"=>'description',"id"=>'area2',"value"=>stripslashes(str_replace(array('\n','\r'),' ',$rec_topstory['p_desc'])))); ?> <span class="required"><?php echo form_error('description'); ?></span></td>
              </tr>
              <tr>
                <td></td>
