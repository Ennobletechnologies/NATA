      ...
      <div class=" col-lg-12 col-md-12">
        <div class="panel panel-primary">
          <div class="panel-heading ">
            ...
            <div class="pull-right"> <a href="<?php echo base_url();?>admin/addpolicies" class="btn btn-success">+ Add New</a> </div>
          </div>
          <div class="panel-body">
            <table class="table table-bordered">
              ...
              <tbody>
                <?php $i=1; foreach ($policies as $key=>$palcy){ ?>
                <tr>
                  <td><?php echo $i; ?></td>
                  <td><?php echo $palcy['title']; ?></td>
                  <td><?php echo strip_slashes(substr($palcy['p_desc'],276,200)); ?></td>
                  <td style="vertical-align:middle"><a href="<?php echo base_url(); ?>admin/EditPolicies/<?php echo $palcy['id']; ?>" class="btn-edit"><i class="fa fa-edit"></i>Edit</a></td>
                  <td style="vertical-align:middle"><a href="<?php echo base_url(); ?>admin/DeletePolicies/<?php echo $palcy['id']; ?>" class="btn-delete"><i class="fa fa-trash"></i>Delete</a></td>
                </tr>
                <?php $i++; } ?>
              </tbody>
            </table>
