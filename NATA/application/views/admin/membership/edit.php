...
<head>
<title>Edit About Membership</title>
...
<div class="container">
  <div class="row">
    <div class=" col-lg-12 col-md-12">
      <?php foreach ($edit_aboutmemship as $key=>$rec_topstory); ?>
      <?php echo form_open_multipart('admin/updateAboutMembership'); ?>
      <div class="panel panel-primary">
        ...
        <div class="panel-body">
          <table class="table table-bordered">
            <tr>
              <td>Title</td>
              <td><?php echo form_input(array("name"=>'title',"value"=>$rec_topstory['am_title'])); ?>
             <?php echo form_error('title'); ?></td>
            </tr>
            <tr>
              <td>Description:</td>
              <td><?php echo form_textarea(array("name"=>'body',"id"=>'area2',"class"=>'wide-content',"value"=>stripslashes(str_replace(array('\n','\r'),' ',$rec_topstory['am_body'])))); ?>
			  <?php echo form_error('body'); ?></td>
            </tr>
            <tr>
              <td></td>
              <td><input type="hidden" name="id" value="<?php echo $rec_topstory['am_id']; ?>" />
