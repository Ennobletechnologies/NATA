...
<section class="member-home">
  <div class="container">
  <div class="row">
  <div class="col-md-12"> <?php echo form_open_multipart('admin/inserttv'); ?>
    <div class="panel panel-primary">
      <div class="panel-heading ">
        ...
        <input type="hidden" name="region" value="default" id="region">
              <input type="submit" class="btn btn-success" name="submit" value="+ Add TV Coverage" />
        </div>
      </div>
      <div class="panel-body">
        <table class="table table-bordered ">
          <tr>
            <td>Title</td>
            <td><?php echo form_input('news_title',set_value('news_title')); ?> <span class="required"><?php echo form_error('news_title'); ?></span></td>
          </tr>
          <tr>
            <td>Description:</td>
          ...
          <tr>
            <td><input type="hidden" name="multi[]" value="3"></td>
