      ...
      <div class=" col-lg-12 col-md-12">
        <div class="panel panel-primary">
          <div class="panel-heading ">
            ...
            <a href="<?php echo base_url(); ?>admin/addBannerImage" class="btn btn-success">+ Add New</a>
            </div>
          </div>
    ...
    foreach ($banner as $key =>$value )
    {
    	?>
            <tr class="odd">
              ...
              <td style="vertical-align:middle"><a href="<?php echo base_url()?>admin/deleteBanner/<?php echo $banner[$key]['banner_id']?>" class="btn-delete"><i class="fa fa-trash"></i>Delete</a></td>
            </tr>
            <?php 
    }
    ?>
