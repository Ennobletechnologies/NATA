        ...
        <div class="panel panel-primary">
          <div class="panel-heading ">
            <ol class="breadcrumb">
              ...
              <li><a href="<?php echo base_url() ?>admin/news">News</a></a>
          ...
          <div class="panel-body"> 
            <table class="table table-bordered">
              <tr>
                <td>Title</td>
                <td>
				<?php echo form_input('news_title',set_value('news_title')); ?> <span class="required"><?php echo form_error('news_title'); ?></span></td>
              </tr>
              <tr>
                <td>Description:</td>
              ...
              <tr>
                <td>Image :</td>
                <td><?php echo form_upload('newspic'); ?>
                  <input type="hidden" name="multi[]" value="1" required="required" ></td>
              </tr>
              <tr>
                <td></td>
