      ...
      <div class=" col-lg-12 col-md-12">
        <div class="panel panel-primary">
          <div class="panel-heading ">
            ...
            <div class="pull-right" style="margin-top:1px;"> <a href="<?php echo base_url();?>admin/addVideos" class="btn btn-success">+ Add New</a> </div>
          </div>
          <div class="panel-body">
            <table class="table table-bordered">
              ...
              <tbody>
                <?php $i=1; foreach ($videos as $key=>$view_topstory){ ?>
                <tr>
                  <td><?php echo $i; ?></td>
                  <td><?php echo $view_topstory['videos_title']; ?></td>
                  <?php if($view_topstory['videos_img']){?>
                  <td><img src="<?php echo $view_topstory['videos_img']; ?>" width="100" /></td>
                  <?php }?>
                  <td style="vertical-align:middle"><a href="<?php echo base_url(); ?>admin/EditVideos/<?php echo $view_topstory['videos_id']; ?>" class="btn-edit"><i class="fa fa-edit"></i>Edit</a></td>
                  <td style="vertical-align:middle"><a href="<?php echo base_url(); ?>admin/DeleteVideos/<?php echo $view_topstory['videos_id']; ?>" class="btn-delete"><i class="fa fa-trash"></i>Delete</a></td>
                </tr>
                <?php $i++; } ?>
              </tbody>
            </table>
