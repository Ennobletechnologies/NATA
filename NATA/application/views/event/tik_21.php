      ...
      <div class="customer-info"> <span class="pull-left">
        ...
        <table class="table orders">
            ...
            $finaldate = date_format($tobeformatdate, 'M,d Y');
				?>
				<h3>Event Name<br/><span><?php echo $tic['event_name'];?> <!--, <?php echo $tic['city'];?></span><br/> <?php
				 echo $finaldate = date_format($tobeformatdate, 'M,d Y');
				?> --></h3></td>
				<td><h4 class="show-times" style="color:#fff;"><i class=""></i><br/>
          <br/>
            </h4></td></tr>
            </table>
        ...
        <div>
            ...
            $finaldate1 = date_format($tobeformatdate1, 'M,d Y h:i a'); echo $finaldate1;?></span></h2></td><td><h2 style="text-align:right;"><b>Registration ID</b> <br/>
	...
	<div class="contact-details" id="divToPrint"  style="display:none;">
      ...
      <div class="customer-info"> <span class="pull-left">
        ...
        <table class="table orders" style="background:#444;">
            ...
            $finaldate = date_format($tobeformatdate, 'M,d Y');
				?>
				<h2 style="color:#fff; font-size:12px;"><b style="margin-bottom:5px; font-size:13px;">Event Name</b> :<br/><br/><?php echo $tic['event_name'];?>
</h2></td>
        ...
        <div>
        	<table class="table" style="margin-top:-30px;">
				...
				$tobeformatdate1 = new DateTime($td1);
            $finaldate1 = date_format($tobeformatdate1, 'M,d Y h:i a'); echo $finaldate1;?></span></h2></td><td><h2 style="text-align:right; font-size:13px;"><b>Registration ID</b> <br/>
          <span><?php echo "ET".$tic['booking_id'];?></span></h2></td></tr>
            </table>
        </div>
      </div>
