...
<div class="container mb40">
 ...
 <?php  if($this->uri->segment(4)==23) {?>
                <div class="col-xs-6 col-sm-6 col-md-6">
                <div class="form-group">
                  <input type="text" name="title" id="title" class="form-control input-md"  placeholder="Title" tabindex="3" required/>
                </div>
              </div>
...
<?php } ?>
         ...
         <div class="form-group">
              <input type="text" name="state" id="state" class="form-control input-md"  placeholder="State" tabindex="6" required/>
               ...
               <div class="col-xs-6 col-sm-6 col-md-6">
                <div class="form-group">
                  <input type="text" name="zip" id="zip" class="form-control input-md" placeholder="Pin/Zip" tabindex="9" required/>
                </div>
              </div>   
                    ...
                    <div class="col-xs-6 col-sm-6 col-md-6">
                <div class="form-group">
                  <input type="text" name="country" id="country" class="form-control input-md" placeholder="Country" tabindex="16" required/>
                </div>
              </div>   
                   <?php } ?> 
              ...
              <div class="col-xs-6 col-sm-6 col-md-6">
                <div class="form-group">
                  <input type="text" name="phoneNumber" id="phoneNumber" class="form-control input-md" placeholder="Mobile Number" tabindex="6" pattern="[0-9]{10}" title="Please Enter Ten Digit mobile Number " required/>
                    ...
                    <div class="col-xs-6 col-sm-6 col-md-6">
                <div class="form-group">
                  <input type="text" name="homephone" id="homephone" class="form-control input-md" placeholder="Work Number" tabindex="9" />
                </div>
              </div>   
                   <?php } ?> 
                     <?php  if($this->uri->segment(4)==24 || $this->uri->segment(4)==21) {?>
                      <div class="col-xs-6 col-sm-6 col-md-6">
                <div class="form-group">
                ...
                <div class="col-xs-6 col-sm-6 col-md-6">
                <div class="form-group">
                  <input type="text" name="filmtitle" id="filmtitle" class="form-control input-md"  placeholder="Film Title" tabindex="3" required/>
                </div>
              </div>
              ...
              <div class="col-xs-6 col-sm-6 col-md-6">
                <div class="form-group">
                  <input type="text" name="filmname" id="filmname" class="form-control input-md" placeholder="Film Name" tabindex="16" required/>
                </div>
              </div>
                     <div class="col-xs-6 col-sm-6 col-md-6">
                <div class="form-group">
                  <input type="text" name="filmgenre" id="filmgenre" class="form-control input-md" placeholder="Film Genre" tabindex="18" required/>
                </div>
              </div>
                    <div class="col-xs-6 col-sm-6 col-md-6">
                <div class="form-group">
                  <input type="text" name="filmduration" id="filmduration" class="form-control input-md" placeholder="Film Duration" tabindex="17" required/>
                </div>
              </div>
               ...
               <?php  } ?>  
                    <div class="col-xs-6 col-sm-6 col-md-6">
                <div class="form-group">
                    <input type="url" name="link" id="link" class="form-control input-md" placeholder="<?php  if($this->uri->segment(4)==23) { echo 'Film Link';} else{ echo 'Link';} ?>" tabindex="6" required>
                      <!--  <lable class="requirecls">*</lable>-->
                </div>
              </div>
                         <?php  if($this->uri->segment(4)==23) {?>
                    <div class="col-xs-6 col-sm-6 col-md-6">
                <div class="form-group">
                  <input type="text" name="addlink1" id="addlink1" class="form-control input-md" placeholder="Additional Link 1" tabindex="17" />
                </div>
              </div>
                      <div class="col-xs-6 col-sm-6 col-md-6">
                <div class="form-group">
                  <input type="text" name="addlink2" id="addlink2" class="form-control input-md" placeholder="Additional Link 2" tabindex="18" />
                </div>
              </div>
                   <?php } ?>
            </div>
...
echo "2016-05-18 09:00:00";}else{    echo $_POST['m_event_datetime']; } ?>">
        ...
        <p>
                ...
                <a href="http://www.nata2016.org/assets/pdf/CONSENT.pdf" target="_blank"> I agree to consent and copyright described above.</a> </p>
                <?php } ?>
