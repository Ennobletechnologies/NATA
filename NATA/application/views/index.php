...
<html lang="en-US">
 ...
 <meta content='width=device-width, initial-scale=1, maximum-scale=1, user-scalable=no' name='viewport'>
        ...
        <meta property="og:image"  content="http://www.nataus.org/img/nata-logo.png" />
        <title><?php echo $title; ?></title>
         <meta name="description" content="<?php if(empty($description)) { echo "	North America Telugu Association(NATA)is in New Jersey 08540,It is the largest organization in North America and it is founded in the year 2013.NATA is a big association for all Telugu peoples who are living in North America. ";} else {echo  $description;}?>">
    ...
    <div class="nata2016"><a href="http://www.nata2016.org/" target="_blank"><img src="<?php echo base_url() ?>img/Nata3rdConventionLogo.png" class="img-responsive" width="100" ><span>Nata Convention 2016</span></a></div>
        <div class="pre-header">
            <div class="container">
                <div class="row">
                    <div class="col-md-2 col-sm-2 nata-logo" ><a href="<?php echo base_url() ?>"><img src="<?php echo base_url() ?>img/nata-logo.png" class="img-responsive" alt="nata-logo"></a></div>
                    ...
                    <div class="col-md-4 col-sm-4 col-xs-12" >      
                        <ul class="list-unstyled list-inline" style="margin:5px 0px 5px 0px;">
                            <li class="phone-icon"> <i class="fa fa-phone"></i><span>NATA-Helpline : 855-628-2435</span></li>
