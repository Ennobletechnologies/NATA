...
<body>
	...
	<?php foreach ($view_gal as $key=>$gal){ ?>
		<a class="fancybox" href="<?php echo base_url(); ?>public/banner/<?php echo $gal['banner_image']; ?>" data-fancybox-group="gallery" title="<?php echo "";?>"><img style="width:14%" src="<?php echo base_url(); ?>public/banner/<?php echo $gal['banner_image']; ?>" alt="" /></a>
