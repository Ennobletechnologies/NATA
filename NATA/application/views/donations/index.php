      ...
      <div class="col-md-9 col-sm-8 news-block">
        ...
        <div class="row">
          <div class="col-md-6 col-sm-12 col-md-offset-3">
            ...
            <form method="post" action="<?php echo base_url();?>services/donation_preview" class="donation-form">
			  ...
			  <div class="form-group">
                <label for="yearsVolunteer">Donation cause</label>
                <input type="text" name="memo" class="form-control" id="memo" placeholder="memo" value="<?php echo set_value('memo');?>">
			  <span class="required"><?php echo form_error('memo');?></span>
    			
            </div>
              <div class="form-group">
                <label for="yearsVolunteer">Amount</label>
                <input type="text" name="amount" class="form-control" id="" placeholder=" Amount" value="<?php echo set_value('amount');?>">
                <span class="required"><?php echo form_error('amount');?></span> <span class="help-block">In USD</span> 
				</div>
