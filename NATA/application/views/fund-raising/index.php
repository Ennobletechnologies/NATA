  ...
  <div class="container">
    <div class="col-md-4 col-sm-5">
      <ol class="breadcrumb">
        ...
        <li class="active">Nata Fund Raising</li>
      </ol>
    </div>
    ...
    <div class="row">
      <div class="col-md-9 col-sm-12 news-block">
        <div class="news-heading">
          <h4>Nata Fund Raising</h4>
        </div>
        <?php foreach ($fund as $fund_data):?>
        <div class="row">
          <div class="col-md-3 col-sm-3 "> <img src="<?php echo base_url();?>public/fundraising/<?php echo $fund_data['fr_image'];?>" class="img-responsive"  alt="news-1"> </div>
          <div class="col-md-9 col-sm-9 ">
            <div class="latest-news ">
              <h5><?php echo $fund_data['fr_title'];?></h5>
              <p><span class="fa fa-clock-o">&nbsp;</span>
                <?php 
                           $result = $fund_data['published_on']; 
                            echo $result;?>
              </p>
              <p><?php echo strip_slashes($fund_data['fr_desc']);?></p>
              <a href="<?php echo base_url();?>events/fund_raising_view/<?php echo $fund_data['fr_id'];?>" class="btn slide_btn">Read More</a> </div>
          </div>
        </div>
      ...
      <div class="col-md-3 col-sm-12 latest-videos">
        ...
        <div class="news-heading">
          <h4>Latest Videos</h4>
        </div> <a href="<?php echo base_url();?>gallery/view/<?php echo $videos_data['videos_id'];?>">
